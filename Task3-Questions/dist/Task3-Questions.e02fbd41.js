...
})({"4SBoZ":[function(require,module,exports,__globalThis) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SERVER_PORT = 56405;
...
const viz = (container, { state, setState })=>{
    ...
    if (data === undefined) {
        ...
        fetch('https://gist.githubusercontent.com/priya-zha/03cfd7a9919c6bfa05430619402a63a4/raw/e8d95ec24d67642ea21d3094e5840ae23fba5d19/weight.csv').then((response)=>response.text()).then((csvString)=>{
...
const scatterPlot = (selection, { data, width, height, xValue, yValue, shapeValue, margin, xAxisLabel, yAxisLabel, shapeLegendLabel, shapeLegendX, shapeLegendY })=>{
    ...
    const shapeScale = (0, _d3.scaleOrdinal)().domain([
        'Male',
        'Female'
    ]) // Assuming the dataset has these categories
    .range([
...
},{"d3":"eyk9f","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["4SBoZ","jOXmm"], "jOXmm", "parcelRequire5d5f")

//# sourceMappingURL=Task3-Questions.e02fbd41.js.map
